...
export { default as ExpressDetailInfo } from './components/ExpressDetailInfo.vue'
export { default as MovieDetailInfo } from './components/MovieDetailInfo.vue'
...
export type { ExpressDetail, LoginForm, MenuItem, MovieDetail } from './types'
